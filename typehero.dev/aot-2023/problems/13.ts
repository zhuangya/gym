...
type DayCounter<Beginning extends number, End extends number> =
  | Exclude<Step<End>, Step<Beginning>>
  | End;

type Step<
  Until extends number,
  Output extends Array<number> = [],
> = Until extends Output["length"]
  ? Output[number]
  : Step<Until, [...Output, Output["length"]]>;
